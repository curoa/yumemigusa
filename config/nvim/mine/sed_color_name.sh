...
sed -i -s "s/=green/=#21ba59/" _highlight.vim check_my_color.vim
...
sed -i -s "s/=grape/=#6964AD/" _highlight.vim check_my_color.vim
...
sed -i -s "s/=orange/=#FF9914/" _highlight.vim check_my_color.vim
